                ...
                if latest_payment:
                    ...
                    if status == "pending":
                        system_instruction = (
                            ...
                            f"Jika user secara tegas meminta dikirimkan ulang QRIS-nya atau ingin dibuatkan QRIS baru, "
                            f"katakan secara santai bahwa kamu akan mengirimkan barcode pembayarannya sekarang.]"
                        )
                        ...
                        system_instruction = (
                            ...
                            f"sudah kedaluwarsa/mati. Tawarkan harga paket dan tanyakan apakah mereka ingin dikirimkan QRIS baru. "
                            f"Jangan langsung mengirimkan QRIS/barcode jika mereka belum menyetujuinya.]"
                        )
                else:
                    ...
                    system_instruction = (
                        ...
                        "katakan dengan santai/casual bahwa mereka belum meminta barcode pembayaran sama sekali. "
                        "JANGAN PERNAH langsung menawarkan/mengirimkan barcode pembayaran jika user baru sekadar menyapa atau menyebut kata kunci singkat (seperti 'vcs'). "
                        "Tawarkan harga terlebih dahulu, lalu tanyakan apakah mereka ingin dibuatkan barcodenya sekarang.]"
                    )
            except Exception as e:
