...
class Config:
    ...
    supabase_table: str = "vip_payments"
    supabase_package_table: str = "vip_packages"
    user_table: str = "vip_users"
    referral_table: str = "vip_referrals"
    withdrawal_table: str = "vip_withdrawals"
...
def load_config():
    ...
    return Config(
        ...
        bot_token=os.getenv("TELEGRAM_BOT_TOKEN", "").strip() or os.getenv("MANAGE_BOT_TOKEN", "").strip(),
        ...
        admin_user_ids=parse_admin_ids(os.getenv("ADMIN_USER_IDS", "") + "," + os.getenv("ADMIN_IDS", "") + "," + os.getenv("OWNER_IDS", "")),
